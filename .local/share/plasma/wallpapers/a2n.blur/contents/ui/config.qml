...
ColumnLayout {
  ...
  Kirigami.FormLayout {
    ...
    QtControls2.SpinBox {
      Kirigami.FormData.label: "Blur animation delay:"
    ...
    // slider for the active color animation delay
    QtControls2.SpinBox {
      Kirigami.FormData.label: "Dim animation delay:"
      id: animationDimDurationSpinBox
      value: cfg_AnimationDurationColor
      onValueChanged: cfg_AnimationDurationColor = value
      from: 0
      to: 60000 // 1 minute in ms
      stepSize: 50
      editable: true
